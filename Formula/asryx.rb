class Asryx < Formula
  desc "Native voice-to-text toggle/CLI (offline, GGML Whisper) with speaker diarization"
  ...
  # NOTE: this file is regenerated by the asryx release workflow on every v* tag.
  # The sha256 below is a placeholder; CI overwrites this file once v0.2.0 is tagged.
